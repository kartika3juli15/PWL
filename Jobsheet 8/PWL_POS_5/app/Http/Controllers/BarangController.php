            ...
            ->addColumn('aksi', function ($barang) {
                return '
                    <div class="btn-group btn-group-sm" role="group" aria-label="Aksi">
                        <button onclick="modalAction(\'' . url('/barang/' . $barang->barang_id . '/show_ajax') . '\')" class="btn btn-info">Detail</button>
                        <button onclick="modalAction(\'' . url('/barang/' . $barang->barang_id . '/edit_ajax') . '\')" class="btn btn-warning">Edit</button>
                        <button onclick="modalAction(\'' . url('/barang/' . $barang->barang_id . '/delete_ajax') . '\')" class="btn btn-danger">Hapus</button>
                    </div>
                ';
            })
            ->rawColumns(['aksi'])
